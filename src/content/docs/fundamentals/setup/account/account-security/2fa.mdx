...
If you are still unable to verify your device, you may contact customer support using the provided link if you have a billing profile with Cloudflare. If you are a free customer with no billed services and cannot verify your email or device we will not be able to reset your 2FA, and you will need to create a new account. At this point you may also be prompted to delete your old account using the provided deletion tool.
